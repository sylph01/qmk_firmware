...
[_QWERTY] = LAYOUT( \
  ...
  KC_LSFT, KC_Z, KC_X,    KC_C,    KC_V,    KC_B,  KC_MHEN,  KC_HENK, KC_N,  KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, \
                 KC_LEFT, KC_DOWN, KC_LGUI, LOWER, KC_SPC,   KC_ENT,  RAISE, KC_RALT, KC_UP  , KC_RGHT\
),
...
[_LOWER] = LAYOUT( \
  ...
  _______, _______, _______, _______, _______, KC_LCBR, _______, _______, KC_RCBR, KC_LEFT, KC_DOWN, KC_RGHT, KC_BSLS, KC_RSFT,\
